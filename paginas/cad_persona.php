...
echo "aqui usuário:". $_SESSION['idEmail']."<br>";
echo "aqui livro:" . $_SESSION['codLivro'] . "<br>";;
echo "aqui persona:" . $codPersonagens . "<br>";;
...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['submit'])) {
    ...
    VALUES (NULL, NULL, ?, ?)");
    if ($sql->execute(array( $_SESSION['codLivro'], $texto))) {
