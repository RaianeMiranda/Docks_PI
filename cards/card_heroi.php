                ...
                <div class="carousel-item active">
                    ...
                    ?>
                        <div class="hero-card card">
                            ...
                            <div class="card-body">
                                <?php echo $values['codSnowflake']; ?>
                            </div>
                        </div>   
                    <?php
                                ////////// subcards
                                $sql2 = $pdo->prepare('SELECT * FROM etapas where codSnowflake = '.$values['codSnowflake']);
                                if ($sql->execute()) {
                                ...
                                ?>
                                        <div class="hero-card card">
                                            <div class="hero-top card-top">
                                                <h4 class="card-text"><?php echo $values2['nome_etapas']?></h4>
                                            </div>
                                            <div class="card-body">
                                                <p class="card-text"><?php echo $values2['descricao']?></p>
                                            </div>
                                        </div>
